...
size = st.slider("Grid Size (dots per side):", 3, 12, 7)
...
def draw_border_arcs(ax, n, spacing):
    """
    Draw arcs connecting border dots so their endpoints meet diamond corners.
    Skips corners and ensures exactly (n-2) arcs per border.
    """
    r = spacing / 2
    offset = spacing / 2
